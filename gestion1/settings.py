"""
Django settings for gestion1 project.
...
SECRET_KEY = "django-insecure-3q&ei(emc3(&g_2^ajd@m+c3wjko5ojas2ial^1*7^d8^ze-=e"
...
WSGI_APPLICATION = "gestion1.wsgi.application"
